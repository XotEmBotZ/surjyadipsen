...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn(
        "group/toggle-group data-[size=sm]:rounded-none(var(--radius-md),10px)] flex w-fit flex-row items-center gap-[--spacing(var(--gap))] rounded-none data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
